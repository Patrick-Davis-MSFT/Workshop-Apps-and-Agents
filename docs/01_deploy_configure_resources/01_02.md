...
![Review the endpoints and keys associated with your Microsoft Foundry project.](../../media/Solution/0102_NewFoundryEndpoint.png)

Then, fill in the following.

- `FOUNDRY_ENDPOINT`: Copy the **Project endpoint** box.
- `FOUNDRY_API_KEY`: Copy the **API key** box.
- `gpt_endpoint`: Copy the **Azure OpenAI endpoint** box. Do *NOT* include openai/v1
- `gpt_api_key`: Copy the **API key** box.
